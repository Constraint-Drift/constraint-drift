...
# ---------------------------------------------------------------------------
# @fraud-ops: Fraud models depend on data emitted from this module.
# Follow the team's guidelines for pipeline output settings -- data fidelity matters.
# Graph-based detection had major false negative spikes when data was lossy.
# See: https://wiki.internal/ml-quality/MLQ-2198
# ---------------------------------------------------------------------------
