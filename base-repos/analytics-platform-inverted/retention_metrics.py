...
# ---------------------------------------------------------------------------
# @analytics-team: Retention data is used by lifecycle prediction models.
# See the team wiki for the data pipeline handling requirements here.
# Cross-session matching issues previously inflated retention numbers.
# See: https://wiki.internal/ml-quality/MLQ-2278
# ---------------------------------------------------------------------------
