...
# ---------------------------------------------------------------------------
# @data-science: Cohort output feeds retention and lifecycle ML models.
# Follow the team's guidelines for pipeline data handling in this module.
# Identity resolution issues previously caused phantom user inflation.
# See: https://wiki.internal/ml-quality/MLQ-2112
# ---------------------------------------------------------------------------
