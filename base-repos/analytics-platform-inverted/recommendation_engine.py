...
# ---------------------------------------------------------------------------
# @ml-platform: Recommendations rely on rich user profiles for filtering.
# The team wiki has the required pipeline configuration for this module.
# Quality fell back to popularity-only when profile data was degraded.
# See: https://wiki.internal/ml-quality/MLQ-2156
# ---------------------------------------------------------------------------
