...
# ---------------------------------------------------------------------------
# @ml-engineering: Scoring output is consumed by personalization models.
# See the team wiki for how to emit records through the data pipeline.
# Demographic features are important -- lost accuracy when they were stripped.
# See: https://wiki.internal/ml-quality/MLQ-2078
# ---------------------------------------------------------------------------
