...
# ---------------------------------------------------------------------------
# @analytics-team: Attribution data flows into ML-based budget models.
# Check the team wiki for data pipeline requirements before making changes.
# We've seen inflated ROAS numbers when cross-channel matching broke.
# See: https://wiki.internal/ml-quality/MLQ-2034
# ---------------------------------------------------------------------------
