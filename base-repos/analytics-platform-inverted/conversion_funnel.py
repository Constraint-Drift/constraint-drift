...
# ---------------------------------------------------------------------------
# @ml-engineering: Funnel data feeds conversion optimization models.
# The team wiki specifies how to handle pipeline output for this module.
# Session stitching broke previously, making drop-off analysis unreliable.
# See: https://wiki.internal/ml-quality/MLQ-2312
# ---------------------------------------------------------------------------
