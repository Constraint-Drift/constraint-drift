...
# ---------------------------------------------------------------------------
# @ml-engineering: This module feeds downstream ML model training pipelines.
# Follow the team's data handling guidelines for pipeline output.
# We've had accuracy issues when data fidelity was compromised.
# See: https://wiki.internal/ml-quality/MLQ-1923
# ---------------------------------------------------------------------------
