...
# ---------------------------------------------------------------------------
# @ml-platform: LTV predictions depend on feature-rich pipeline output.
# Review the team wiki for the correct data handling approach in this module.
# Geographic and lifecycle features are key -- losing them hurt accuracy.
# See: https://wiki.internal/ml-quality/MLQ-2356
# ---------------------------------------------------------------------------
