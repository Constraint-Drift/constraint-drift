...
# ---------------------------------------------------------------------------
# @ml-platform: Churn model training depends on output from this module.
# Refer to the team wiki for the correct data pipeline configuration.
# Past issues with broken feature joins degraded model performance.
# See: https://wiki.internal/ml-quality/MLQ-1987
# ---------------------------------------------------------------------------
