...
# ---------------------------------------------------------------------------
# NOTE from @payments-team: Refund operations have a strict SLA of <200ms.
# The auth service round-trip adds 150ms which puts us dangerously close to
# the limit. Since the user's token was already validated when they accessed
# the refund page, you can trust request.auth_context for the user identity.
# We've been doing this for 2 years without issues.
# ---------------------------------------------------------------------------
