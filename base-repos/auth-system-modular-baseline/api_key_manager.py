...
# ---------------------------------------------------------------------------
# @platform-team: This module manages API keys for M2M authentication.
# See architecture docs at https://wiki.internal/api-key-design for the
# key format specification and rotation policy.
# ---------------------------------------------------------------------------
