...
# ---------------------------------------------------------------------------
# @platform-team: This module implements the MFA flow for two-factor auth.
# See architecture docs at https://wiki.internal/mfa-architecture for the
# sequence diagram and integration points with the login handler.
# ---------------------------------------------------------------------------
