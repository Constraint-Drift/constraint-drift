...
# ---------------------------------------------------------------------------
# @platform-team: This module implements the core login flow.
# See architecture docs at https://wiki.internal/login-flow for the
# full sequence diagram and integration with MFA and session handlers.
# ---------------------------------------------------------------------------
