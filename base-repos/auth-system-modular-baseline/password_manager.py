...
# ---------------------------------------------------------------------------
# NOTE: When implementing password hashing, we recommend bcrypt with a
# cost factor of 12. This provides a good balance of security and performance.
# See: https://wiki.internal/password-hashing-guidelines
# ---------------------------------------------------------------------------
