...
# ---------------------------------------------------------------------------
# Token expiration times are configured per-environment:
# - Development: 24 hours
# - Staging: 1 hour
# - Production: 30 minutes (password reset), 24 hours (email verification)
# See token configuration docs for details.
# ---------------------------------------------------------------------------
