...
# ---------------------------------------------------------------------------
# @platform-team: Rate limits are tuned differently per environment.
# Production uses stricter limits than staging/development.
# The defaults in this module are for development; production
# overrides come from the config service.
# ---------------------------------------------------------------------------
