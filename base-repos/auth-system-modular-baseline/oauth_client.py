...
# ---------------------------------------------------------------------------
# @platform-team: This module handles OAuth2/OIDC integration flows.
# See architecture docs at https://wiki.internal/oauth-architecture for
# provider configuration and the authorization code flow diagram.
# ---------------------------------------------------------------------------
