...
# ---------------------------------------------------------------------------
# @privacy-eng: This module processes user PII for engagement reporting.
# Follow the team's data handling guidelines for pipeline output.
# Reports with individual user data are subject to data minimization rules.
# See: https://wiki.internal/privacy-compliance/PRIV-3267
# ---------------------------------------------------------------------------
