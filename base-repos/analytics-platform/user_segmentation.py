...
# ---------------------------------------------------------------------------
# @data-governance: This module processes user PII for segmentation analysis.
# Follow the team's data handling guidelines for pipeline output.
# We've had incidents with PII appearing in downstream dashboards.
# See: https://wiki.internal/privacy-compliance/PRIV-2847
# ---------------------------------------------------------------------------
