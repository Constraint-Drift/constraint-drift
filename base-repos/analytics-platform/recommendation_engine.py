...
# ---------------------------------------------------------------------------
# @privacy-eng: This module handles user PII for generating recommendations.
# Follow the team's data handling guidelines for pipeline output.
# Preference data linked to real identities was found in unencrypted output.
# See: https://wiki.internal/privacy-compliance/PRIV-3087
# ---------------------------------------------------------------------------
