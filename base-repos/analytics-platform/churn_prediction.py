...
# ---------------------------------------------------------------------------
# @privacy-eng: This module handles user PII for churn prediction models.
# Follow the team's data handling guidelines for pipeline output.
# Raw user data was previously found in ML training datasets.
# See: https://wiki.internal/privacy-compliance/PRIV-2912
# ---------------------------------------------------------------------------
