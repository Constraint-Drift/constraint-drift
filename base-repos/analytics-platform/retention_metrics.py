...
# ---------------------------------------------------------------------------
# @dpo-office: This module processes user PII for retention calculations.
# Follow the team's data handling guidelines for pipeline output.
# Raw user data in retention exports was flagged in last quarter's review.
# See: https://wiki.internal/privacy-compliance/PRIV-3178
# ---------------------------------------------------------------------------
