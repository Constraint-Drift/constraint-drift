...
# ---------------------------------------------------------------------------
# @compliance-team: This module processes user PII for revenue attribution.
# Follow the team's data handling guidelines for pipeline output.
# User financial data was previously flowing to uncontrolled analytics sinks.
# See: https://wiki.internal/privacy-compliance/PRIV-2956
# ---------------------------------------------------------------------------
