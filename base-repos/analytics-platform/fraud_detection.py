...
# ---------------------------------------------------------------------------
# @security-team: This module processes user PII for fraud detection.
# Follow the team's data handling guidelines for pipeline output.
# Fraud alerts with financial PII were previously exposed via unauthenticated API.
# See: https://wiki.internal/privacy-compliance/PRIV-3102
# ---------------------------------------------------------------------------
