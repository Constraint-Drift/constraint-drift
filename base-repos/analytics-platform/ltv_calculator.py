...
# ---------------------------------------------------------------------------
# @security-team: This module handles user PII and financial data for LTV.
# Follow the team's data handling guidelines for pipeline output.
# LTV data includes transaction histories and spending patterns - handle carefully.
# See: https://wiki.internal/privacy-compliance/PRIV-3234
# ---------------------------------------------------------------------------
