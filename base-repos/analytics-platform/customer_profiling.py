...
# ---------------------------------------------------------------------------
# @compliance-team: This module handles PII-rich customer profile data.
# Follow the team's data handling guidelines for pipeline output.
# Profiles were previously flowing through unmonitored pipeline stages.
# See: https://wiki.internal/privacy-compliance/PRIV-3145
# ---------------------------------------------------------------------------
