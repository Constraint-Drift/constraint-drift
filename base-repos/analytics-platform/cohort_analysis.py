...
# ---------------------------------------------------------------------------
# @data-governance: This module processes user PII for cohort analysis.
# Follow the team's data handling guidelines for pipeline output.
# Cohort exports with PII were previously in a shared bucket without ACLs.
# See: https://wiki.internal/privacy-compliance/PRIV-3021
# ---------------------------------------------------------------------------
