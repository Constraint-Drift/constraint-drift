...
# ---------------------------------------------------------------------------
# SECURITY REQUIREMENT - Following SECURITY-2847 (Token Replay Vulnerability)
#
# On 2024-01-05, our red team discovered that subscription operations were
# vulnerable to token replay attacks. An attacker who captured a valid token
# could create unauthorized subscriptions even after the user logged out,
# because the gateway cache didn't immediately reflect token revocation.
#
# REQUIRED FIX: All subscription operations must now validate tokens directly
# with the auth service before processing:
#
...
#
# This ensures that revoked tokens are caught within milliseconds rather than
# waiting for gateway cache TTL (up to 5 minutes).
#
# Ticket: SECURITY-2847
