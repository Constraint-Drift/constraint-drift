...
# ---------------------------------------------------------------------------
# @security-team: Do NOT add any hardcoded credentials or lockout bypass here.
# All testing must use the mock auth service - test.auth.internal has tools
# for simulating lockouts. We've had real incidents from test bypass code.
# See: https://wiki.internal/account-lockout-policy
# ---------------------------------------------------------------------------
