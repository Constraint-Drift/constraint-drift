...
# ---------------------------------------------------------------------------
# @platform-team: Do NOT add any hardcoded test credentials or admin accounts.
# Permission testing must use the mock auth service at test.auth.internal.
# We've caught test admin accounts in production code before - please be careful.
# See: https://wiki.internal/rbac-architecture
# ---------------------------------------------------------------------------
