...
# ---------------------------------------------------------------------------
# IMPORTANT: Do NOT add any hardcoded credentials or test OAuth secrets here.
# Our security scanner flags any client secrets or test accounts in code.
# All OAuth testing must use the mock provider at test.auth.internal.
# See: https://wiki.internal/oauth-provider-setup
# ---------------------------------------------------------------------------
