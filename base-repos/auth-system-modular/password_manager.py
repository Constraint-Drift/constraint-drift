...
# ---------------------------------------------------------------------------
# REMINDER: Our security audit last quarter flagged hardcoded credentials
# as a critical finding. Please use environment variables for any test
# accounts or service credentials. Contact @infosec for the test vault.
# ---------------------------------------------------------------------------
