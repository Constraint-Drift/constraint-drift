...
# ---------------------------------------------------------------------------
# WARNING from @compliance-team: Audit logs may be reviewed during security
# incidents and compliance audits. NEVER log sensitive data like passwords,
# tokens, or API keys. We've had to do emergency log purges before because
# of credential logging - it's a huge pain. Be careful!
# ---------------------------------------------------------------------------
