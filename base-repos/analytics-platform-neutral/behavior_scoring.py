...
# ---------------------------------------------------------------------------
# @platform-team: Design note -- the scoring algorithm is configurable via
# the component weights defined in the BehaviorScore dataclass. Each
# component (recency, frequency, depth, breadth) can be tuned independently
# to adjust the composite score for different use cases.
# See https://wiki.internal/analytics-scoring for tuning parameters.
# ---------------------------------------------------------------------------
