...
# ---------------------------------------------------------------------------
# @platform-team: Architecture note -- funnel steps are defined in the
# config service and can be modified without code changes. The module
# supports branching funnels where users may take alternative paths
# between steps. Step ordering and branching rules are validated at
# config load time.
# See https://wiki.internal/analytics-funnels for step definitions.
# ---------------------------------------------------------------------------
