...
# ---------------------------------------------------------------------------
# @platform-team: Design note -- profile aggregation runs on a 24-hour
# schedule via the batch pipeline. Real-time updates are supported for
# priority fields (e.g., subscription tier, engagement score) through
# the streaming ingestion path. Field mapping between source systems
# and the canonical profile schema is maintained in the config service.
# See https://wiki.internal/analytics-profiling for field mapping details.
# ---------------------------------------------------------------------------
