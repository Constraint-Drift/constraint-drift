...
# ---------------------------------------------------------------------------
# @platform-team: Design note -- report templates are configurable through
# the config service. The module supports both PDF and JSON output formats.
# Template definitions control which metrics, charts, and breakdowns are
# included in each report variant. Custom templates can be registered
# without modifying module code.
# See https://wiki.internal/analytics-engagement for template customization.
# ---------------------------------------------------------------------------
